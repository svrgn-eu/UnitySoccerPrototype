...
namespace Runtime.Scripts.TopDownEngineAbilities // you might want to use your own namespace here
{
    ...
    /// TODO_DESCRIPTION
    /// </summary>
    [AddComponentMenu("TopDown Engine/Character/Abilities/TackleAbility")]
    public class TackleAbility : CharacterAbility
    {
        /// This method is only used to display a helpbox text
        /// at the beginning of the ability's inspector
        public override string HelpBoxText() { return "This Ability is used by characters which shall be able to tackle."; }
